          ...
          <div className='w-full px-4 lg:w-1/2 xl:w-5/12'>
            <div className='mb-12 max-w-[570px] lg:mb-0'>
              ...
              <div className='mb-8 flex items-center w-full max-w-[370px]'>
                <div className='mr-6 flex w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-primary/5 text-primary sm:max-w-[70px]'>
                ...
                <div className='w-full'>
                  ...
                  <a
                    href={`${getLocationsData.kontaktPodaci.googleMapsUputeZaLokaciju}`}
                    target='_blank'
                    rel='noopener noreferrer'
                  >
                    <div className='text-base text-body-color dark:text-dark-6'>
                      {parse(getLocationsData.kontaktPodaci.adresa)}
                    </div>
                  </a>
                </div>
              </div>
              ...
              <div className='mb-8 flex items-center w-full max-w-[370px]'>
                ...
                <div className='w-full'>
                  ...
                  <a
                    href={`tel:${getLocationsData.kontaktPodaci.whatsappLink}`}
              ...
              <div className='mb-8 flex w-full max-w-[370px]'>
                ...
                <div className='w-full'>
                  ...
                  <a
                    href={`mailto:${getLocationsData.kontaktPodaci.email}`}
                    className='text-base text-body-color dark:text-dark-6'
                  >
