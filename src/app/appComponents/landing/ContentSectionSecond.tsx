        ...
        <div className='flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4'>
          <div className='p-4 md:w-1/3 sm:mb-0 mb-6'>
            ...
            <p className='text-base leading-relaxed mt-2'>
              Swag shoindxgoitch literally meditation subway tile tumblr cold-pressed. Gastropub street art beard
          ...
          <div className='p-4 md:w-1/3 sm:mb-0 mb-6'>
            ...
            <p className='text-base leading-relaxed mt-2'>
              Swag shoindxigoitch literally meditation subway tile tumblr cold-pressed. Gastropub street art beard
              dreamcatcher neutra, ethical XOXO lumbersexual.
            </p>
            <a className='text-indigo-400 inline-flex items-center mt-3'>
              Learn More
          ...
          <div className='p-4 md:w-1/3 sm:mb-0 mb-6'>
            ...
            <p className='text-base leading-relaxed mt-2'>
              Swag shoindegoitch literally meditation subway tile tumblr cold-pressed. Gastropub street art beard
              dreamcatcher neutra, ethical XOXO lumbersexual.
            </p>
            <a className='text-indigo-400 inline-flex items-center mt-3'>
              Learn More
