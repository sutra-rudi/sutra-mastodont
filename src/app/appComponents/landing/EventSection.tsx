...
export default function EventSection({ dataset, currentLang, arrows }: EventSection) {
  ...
  return (
    <section id={t} className='lg:-mt--desktop---5xl md:-mt--tablet---5xl -mt--mobile---5xl relative w-full'>
      ...
      <div ref={ref} className='container mx-auto px-4 lg:-mt--desktop---3xl md:-mt--tablet---3xl -mt--mobile---3xl'>
        <div className='w-full relative flex gap-4 items-center justify-end lg:-mb--desktop---l md:-mb--tablet---l -mb--mobile---l'>
        ...
        <div ref={emblaRef} className='embla'>
          <div className='flex items-start justify-start gap-6 embla__container'>
            {dataset.map((ds: any) => {
              return (
                <a
                  ...
                  className='block max-w-[433px] bg-almost-white group rounded-lg shadow-md min-w-0 w-full shrink-0'
                >
                  <article className='pb-6'>
                    ...
                    <div className='px-4 flex-col flex'>
                      <span className='lg:text-nadnaslov-desktop md:text-nadnaslov-tablet text-nadnaslov-mobile text-nadnaslov-color-light-mode dark:text-nadnaslov-color-light-mode mt-3 block relative motion-ease-spring-bouncy group-hover:motion-preset-slide-up'>
                        {dayjs(ds.node.eventUvod.pocetakEventaVrijemeDarumGrupa.datumEventaPocetak).format(
                          'DD/MM/YYYY'
                        )}
                      </span>
