...
export default function ContentSectionFirst({ reverse }: ContentSectionSecond) {
  return (
          ...
          <div className={`${reverse ? 'order-1' : 'order-2'} w-full px-4 lg:w-1/2 xl:w-5/12`}>
            <div className='mt-10 lg:mt-0'>
              ...
              <p className='mb-8 text-base text-body-color dark:text-dark-6'>
                A domain name is one of the first steps to establishing your brand. Secure a consistent brand image with
