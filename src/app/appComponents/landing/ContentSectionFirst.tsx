...
export default function ContentSectionFirst({ reverse, content, isList, currentLang, bg }: ContentSectionSecond) {
  ...
  return (
    <section id={parseTitle} className='relative '>
          ...
          layers={[
            {
              ...
              children: (
                <picture>
                  <img src={bg.texturePaper} alt='' className=' w-full  object-cover object-center h-full z-40' />
                </picture>
              ),
            },
          ]}
      ...
      <div className='container mx-auto relative z-10 w-full h-full'>
        <div className='flex lg:flex-nowrap flex-wrap justify-center lg:gap-8 md:gap-6 gap-8 w-full h-full  lg:-pt--desktop---section-l md:-pt--tablet---section-l -pt--mobile---section-l -pb--mobile---section-l'>
