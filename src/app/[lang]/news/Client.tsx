              ...
              return (
                ...
                blog.node.introNews.statusNovosti && (
                  <a
                    ...
                    className='block max-w-[433px] bg-almost-white group rounded-lg shadow-md motion-preset-slide-down-left-sm motion-ease-spring-bouncy'
                  >
              ...
              return (
                ...
                blog.node.introNews.statusNovosti && (
                  <a
                    ...
                    className='embla__slide_blog_gallery  block max-w-[433px] w-full bg-almost-white group rounded-lg shadow-md motion-preset-slide-down-sm motion-ease-spring-smooth'
                    key={blog.node.databaseId}
                    href={`/${currentLang}/news/${slugify(
                      blog.node.sadrzajHrFields.naslovSadrzajHr + `-${blog.node.databaseId}`,
                      {
