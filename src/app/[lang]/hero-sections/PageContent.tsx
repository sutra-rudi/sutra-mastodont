...
export const HeroVersionThree = ({ pathsToMasks, pathsToHeroBg }: HeroVersion) => {
  return (
    <section>
      <div className='relative w-full h-full min-h-[calc(100vh-5rem)]'>
        <Image
...
export const HeroVersionFour = ({ pathsToMasks, pathsToHeroBg }: HeroVersion) => {
  return (
    <section>
      <div className='relative w-full h-full min-h-[calc(100vh-5rem)]'>
        <Image
...
export const HeroVersionFive = ({ pathsToMasks, pathsToHeroBg }: HeroVersion) => {
  return (
    <section>
      <div className='relative w-full h-full min-h-[calc(100vh-5rem)]'>
        <Image
...
export const HeroVersionSix = ({ pathsToMasks, pathsToHeroBg }: HeroVersion) => {
  return (
    <section>
      <div className='relative w-full h-full min-h-[calc(100vh-5rem)]'>
        <Image
